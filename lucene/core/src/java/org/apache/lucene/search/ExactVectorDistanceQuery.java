...
public class ExactVectorDistanceQuery extends Query {
  ...
  public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost) throws IOException {
    return new ExactVectorDistanceWeight(this, boost, scoreMode, field, queryVector);
  }
  ...
  private static class ExactVectorDistanceWeight extends Weight {
    ...
    ExactVectorDistanceWeight(Query query, float boost, ScoreMode scoreMode,
                              String field, float[] queryVector) {
      super(query);
