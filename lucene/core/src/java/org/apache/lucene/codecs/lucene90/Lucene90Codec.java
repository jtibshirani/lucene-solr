...
public class Lucene90Codec extends Codec {
  ...
  public static enum Mode {
    ...
    BEST_SPEED(Lucene90StoredFieldsFormat.Mode.BEST_SPEED, Lucene80DocValuesFormat.Mode.BEST_SPEED),
    ...
    private Mode(Lucene90StoredFieldsFormat.Mode storedMode, Lucene80DocValuesFormat.Mode dvMode) {
