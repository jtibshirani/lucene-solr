...
public class Lucene90CompressingStoredFieldsFormat extends StoredFieldsFormat {
   ...
   *
   * @see Lucene90CompressingStoredFieldsFormat#Lucene90CompressingStoredFieldsFormat(String, String,
   ...
   * Lucene90CompressingStoredFieldsFormat}s that have the same name but different {@link CompressionMode}s.
   *
