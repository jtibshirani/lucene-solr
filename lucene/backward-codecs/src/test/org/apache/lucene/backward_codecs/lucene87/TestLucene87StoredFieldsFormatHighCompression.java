...
import org.apache.lucene.backward_codecs.lucene87.Lucene87StoredFieldsFormat.Mode;
...
public class TestLucene87StoredFieldsFormatHighCompression extends BaseStoredFieldsFormatTestCase {
  ...
  protected Codec getCodec() {
    return new Lucene87RWCodec(Mode.BEST_COMPRESSION);
  }
  ...
  public void testMixedCompressions() throws Exception {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      iwc.setCodec(new Lucene87RWCodec(RandomPicks.randomFrom(random(), Mode.values())));
