 ...
 * @lucene.experimental
 */
public class Lucene87CompressingStoredFieldsFormat extends StoredFieldsFormat {
  ...
  /**
   * Create a new {@link Lucene87CompressingStoredFieldsFormat} with an empty segment suffix.
   *
   * @see Lucene87CompressingStoredFieldsFormat#Lucene87CompressingStoredFieldsFormat(String, String,
   *     CompressionMode, int, int, int)
   */
  public Lucene87CompressingStoredFieldsFormat(
      String formatName,
  ...
  /**
   * Create a new {@link Lucene87CompressingStoredFieldsFormat}.
   *
   ...
   * Lucene87CompressingStoredFieldsFormat}s that have the same name but different {@link CompressionMode}s.
   *
  ...
  public StoredFieldsReader fieldsReader(
    ...
    return new Lucene87CompressingStoredFieldsReader(
  ...
  public StoredFieldsWriter fieldsWriter(Directory directory, SegmentInfo si, IOContext context)
      throws IOException {
    return new Lucene87CompressingStoredFieldsWriter(
        directory,
        si,
        segmentSuffix,
        context,
